...
config = dict(
    experiment_name='flow_and_pose_v3_4',
    ...
    model_save_path='../../src/weights/flow_and_pose_v3_4'
)
...
checkpoint = load_checkpoint('../../src/weights/flow_and_pose_v3_2_1.pth', config['device'])
