# Turn off all computations after second stage of transformer
...
def focalnet_base_partial(**kwargs):
    return FocalNet(
        depths=[2, 2], embed_dim=128, focal_levels=[3, 3], focal_window=[3, 3],
        drop_path_rate=0, **kwargs)


def focalnet_large_partial(**kwargs):
    return FocalNet(
        depths=[2, 2], embed_dim=192, focal_levels=[4, 4], focal_window=[3, 3],
        drop_path_rate=0, use_conv_embed=True, use_postln=True, use_layerscale=True, normalize_modulator=True, **kwargs)
