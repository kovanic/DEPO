...
from .pose_regressors import DensePoseRegressorV1, DensePoseRegressorV2, DensePoseRegressorV3, DensePoseRegressorV4, DensePoseRegressorV5
...
class LaDEPO(DEPO_v1):
    ...
    def __init__(self, self_encoder, cross_encoder, pose_regressor, mode, hid_dim, num_emb, upsample_factor=1):
        super(DEPO_v1, self).__init__(
            self_encoder=self_encoder, cross_encoder=cross_encoder,
            pose_regressor=pose_regressor, mode=mode, hid_dim=hid_dim,
            num_emb=num_emb, upsample_factor=upsample_factor)
